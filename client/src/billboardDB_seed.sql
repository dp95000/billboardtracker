...
CREATE TABLE contracts (
  ...
  montly_rent(10,4) NULL,
  delinquent_account VARCHAR(100) NULL,
  past_due_payment INT NULL,
  PRIMARY KEY (id)
);

INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('John', 'Doe', 'Walmart', '702 S.W. 8th St. Bentonville, Arkansas, AK 72716', '800-925-6278', 6, '000, 011, 019, 084, 124, 150', '6 months', '$6,800 per month', 'No', 0.00);
INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('George', 'Smith', 'Wawa', 'Red Roof, 260 W. Baltimore Pike, Wawa, Pennsylvania 19063', '610-358-8000', 10, '001, 012, 020, 088, 124, 148', '3 months', '$6,800 per month', 'No', 0.00);
INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('Mike', 'Greg', 'Dunkin Donuts', '130 Royall St, Canton, MA 02021', '781-737-3000', 6, '003, 016, 025, 081, 125, 143', '3 months', '$6,800 per month', 'No', 0.00);
INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('Tim', 'Cook', 'Apple', 'One Apple Park Way, Cupertino, CA 95014', '408-996–1010', 4, '007, 013, 050, 072', '3 months', '$4,500 per month', 'No', 0.00);
INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('Ray', 'Crock', 'McDonalds', '1 McDonalds Plaza, Oak Brook, Illinois 60523', '800-244-6227', 4, '008, 022, 091, 077', '6 months', '$4,500 per month', 'No', 0.00);
INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('Ed', 'Johston', 'Nike', 'One Bowerman Drive, Beaverton, OR 97005', '503-671-6453', 5, '008, 022, 091, 077', '3 months', '$4,500 per month', 'No', 0.00);
INSERT INTO contracts (first_name, last_name, business_name, bill_address, phone_number, number_signs, contract_term, montly_rent) VALUES ('Joe', 'Shmoe', 'Comcast', '1701 JFK Blvd. Philadelphia, PA 19103', '215-286-1700', 7, '008, 022, 091, 077', '3 months', '$4,500 per month', 'No', 0.00);
...
INSERT INTO users (user_name, password) VALUES ('david', '' );
INSERT INTO users (user_name, password) VALUES ('ian', '' );
INSERT INTO users (user_name, password) VALUES ('tyler', '' );
INSERT INTO users (user_name, password) VALUES ('didier', '' );